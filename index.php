...
<div  class="collapse navbar-collapse design " id="collapsibleNavbar">
    ...
    <div class="row">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="col-sm-1">
      <li class="nav-item">
        <a  id="signup" class="nav-link" href="signin.php">SignIn</a>
        </li>
          </div>
        <div class="col-sm-1">
...
document.getElementById("logout").style.display = "none";
       ...
       <div class="row">
        ...
        <div class="col-sm-6 ">
            ...
            <hr >
                 ...
                 <p style="font-size:1.2em;"> <br>At least once in a life, everyone had experienced vehical breakdown which force you to search for mechanics .How  painful was that! Finding mechanics or petrol pump isn't that easy,is it? So , We are here to reduce your entire burden to find mechanics and Gas Station in case of vehical breakdown.  </p>

               <p style="font-size:1.2em;"> <br><b  style="color: coral; font-family: 'Dancing Script', cursive; font-size: 1.8em; "> RoadSide Assistant </b>helps you to find nearest Mechanics, Petrol Pump on ONE CLICK . You just have to enter the location (eg.name of city) and within a second we will provide you nearest service center with detail information.</p>
  ...
  <section  style="text-align: center ;" id="service">
    ...
    <footer class="foooter-background" id="about">
        ...
        <p style="text-align: center;font-family: 'Dancing Script', cursive;font-size: 1.1em;"> © 2018 RoadSide-Assistance. All rights reserved </p>
    </footer>
</body>
</html>
